...
if __name__ == '__main__':
    ...
    src = Path('/Volumes/SAMSUNG/SyngentaStrainScreen/MaskedVideos/20200306')
    dst = Path('/Volumes/SAMSUNG/SyngentaStrainScreen/AuxiliaryFiles/20200306/wells_annotations')
